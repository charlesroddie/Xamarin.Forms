...
namespace Xamarin
{
	...
	/// </summary>
	public class FactDiscoverer : global::Xunit.Sdk.FactDiscoverer
	{
	...
	/// </summary>
	[TraitDiscoverer("Xamarin.CategoryDiscoverer", "Xunit.DeviceTestUtils")]
	...
	[XunitTestCaseDiscoverer("Xamarin.FactDiscoverer", "Xunit.DeviceTestUtils")]
	...
	/// </summary>
	[AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
	[XunitTestCaseDiscoverer("Xamarin.TheoryDiscoverer", "Xunit.DeviceTestUtils")]
	public class TheoryAttribute : global::Xunit.TheoryAttribute
	{
...
#pragma warning restore xUnit3000 // Test case classes must derive directly or indirectly from Xunit.LongLivedMarshalByRefObject
	{
		...
		public string DisplayName => $"{GetCategoryPrefix()}{_inner.DisplayName}";
