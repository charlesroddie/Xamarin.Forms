namespace Xamarin.Essentials.DeviceTests
{
	static class HardwareSupport
	{
		...
		public static bool HasGyroscope =>
			...
			Xamarin.Essentials.Platform.SensorManager?.GetDefaultSensor(global::Android.Hardware.SensorType.Gyroscope) != null;
#elif __IOS__
		...
		public static bool HasFlash =>
			...
			Xamarin.Essentials.Platform.HasSystemFeature(global::Android.Content.PM.PackageManager.FeatureCameraFlash);
#elif __IOS__
